...
public class AwardCombatXpTask extends CancellableRunnable {
    ...
    public void run() {
        ...
        mcMMO.p.getFoliaLib().getScheduler().runAtEntity(mmoPlayer.getPlayer(), task -> mmoPlayer.beginXpGain(primarySkillType, (int) (finalDamage * baseXp), xpGainReason, XPGainSource.SELF));
    }
}
