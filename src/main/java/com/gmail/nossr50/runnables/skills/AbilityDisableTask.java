...
//        ParticleEffectUtils.playAbilityDisabledEffect(player);
        ...
        if (!mcMMO.isServerShutdownExecuted()) {
            mcMMO.p.getFoliaLib().getScheduler().runAtEntityLater(player, new AbilityCooldownTask(mmoPlayer, ability), (long) PerksUtils.handleCooldownPerks(player, ability.getCooldown()) * Misc.TICK_CONVERSION_FACTOR);
        }
    }
