...
/*    public static final float ANVIL_USE_PITCH  = 0.3F;  // Not in CB directly, I went off the place sound values
     ...
     */
    public static boolean isNPCEntityExcludingVillagers(@NotNull final Entity entity) {
        return (!isVillager(entity)
                && isNPCIncludingVillagers(entity)); //Compatibility with some mod..
    }

    public static boolean isNPCClassType(final Entity entity) {
        return entity instanceof NPC;
    }

    public static boolean hasNPCMetadataTag(final Entity entity) {
        return entity.hasMetadata("NPC");
    }

    public static boolean isVillager(final Entity entity) {
    ...
    public static boolean isNPCIncludingVillagers(@Nullable final Entity entity) {
        return (entity == null
     ...
     */
    public static boolean isNear(@NotNull final Location first, @NotNull final Location second,
     ...
     */
    public static Location getBlockCenter(final BlockState blockState) {
    ...
    public static Location getBlockCenter(final Location location) {
        return location.clone().add(0.5, 0.5, 0.5);
    }

    public static void profileCleanup(@NotNull final String playerName) {
    ...
    public static void printProgress(final int convertedUsers, final int progressInterval, final long startMillis) {
    ...
    public static String getModName(@NotNull final String materialName) {
        for (final String mod : modNames) {
            if (materialName.contains(mod)) {
                return mod;
            }
        }

        final String[] materialSplit = materialName.split("_");
     ...
     */
    public static Location getLocationOffset(@NotNull final Location location, final double strength) {
     ...
     */
    public static boolean isPartyLeader(@NotNull final McMMOPlayer mmoPlayer) {
...
//    }
    ...
    public static void spawnExperienceOrb(@NotNull final Location location, final int experienceValue) {
