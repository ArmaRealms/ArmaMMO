...
public final class LocaleLoader {
    ...
    public static String addColors(String input) {
        ...
        input = input.replace("&0", ChatColor.BLACK.toString());
        input = input.replace("&1", ChatColor.DARK_BLUE.toString());
        input = input.replace("&2", ChatColor.DARK_GREEN.toString());
        input = input.replace("&3", ChatColor.DARK_AQUA.toString());
        input = input.replace("&4", ChatColor.DARK_RED.toString());
        input = input.replace("&5", ChatColor.DARK_PURPLE.toString());
        input = input.replace("&6", ChatColor.GOLD.toString());
        input = input.replace("&7", ChatColor.GRAY.toString());
        input = input.replace("&8", ChatColor.DARK_GRAY.toString());
        input = input.replace("&9", ChatColor.BLUE.toString());
        input = input.replace("&a", ChatColor.GREEN.toString());
        input = input.replace("&b", ChatColor.AQUA.toString());
        input = input.replace("&c", ChatColor.RED.toString());
        input = input.replace("&d", ChatColor.LIGHT_PURPLE.toString());
        input = input.replace("&e", ChatColor.YELLOW.toString());
        input = input.replace("&f", ChatColor.WHITE.toString());
        input = input.replace("&l", ChatColor.BOLD.toString());
        input = input.replace("&n", ChatColor.UNDERLINE.toString());
        input = input.replace("&o", ChatColor.ITALIC.toString());
        input = input.replace("&m", ChatColor.STRIKETHROUGH.toString());
        input = input.replace("&?", ChatColor.MAGIC.toString());
        input = input.replace("&r", ChatColor.RESET.toString());
